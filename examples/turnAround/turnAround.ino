...
biWheel chassis = biWheel(2, 3, 4, 5, 9, 10);
...
void loop(){
	...
	chassis.drive(LM, -30);		//левый мотор вращается назад со скоростью 80% от максимальной
	chassis.drive(RM, 30);		//правый мотор вращается вперед со скоростью 80% от максимальной
